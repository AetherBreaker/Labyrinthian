...
#if TYPE_CHECKING:
#	from labyrinthianinit import Labyrinthian
...
class Browser(disnake.ui.View):
	def __init__(self, inter, embeds: List[disnake.Embed], charslist: list, badgelog:list, owner: disnake.User, guild: disnake.Guild, charname: str=None):
		super().__init__(timeout=180)
		self.owner = owner
		self.guild = guild
		self.charslist = charslist
		self.badgelog = badgelog
